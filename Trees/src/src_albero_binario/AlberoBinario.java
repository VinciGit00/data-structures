 ...
 * ogni nodo &egrave; al pi&ugrave; 2. I figli di un albero binario hanno
 * pertanto un ordine e sono distinti in figlio sinistro e figlio destro. In un
 * albero binario, un nodo potrebbe avere un figlio sinistro, ma essere privo
...
public interface AlberoBinario {
	 ...
	 * 
	 * @param v il NodoBinario di cui si vuol conoscere se � figlio sinistro
	 ...
	 * 
	 * @param v il NodoBinario di cui si vuol conoscere se � figlio destro
	 ...
	 * 
	 * @return profondità (un intero) dell'albero
	 */
