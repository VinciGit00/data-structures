...
public class JGraphtExample2bis {
	public static void main(String[] args) {
		...
		// Esplicito un peso quando creo un arcomì, gli archi di peso negativo non sono
		// ammessi
		Graph<String, DefaultWeightedEdge> grafo = new DefaultDirectedWeightedGraph<String, DefaultWeightedEdge>(
		...
		// grafo.setEdgeWeight(arco, -4.0);//java.lang.IllegalArgumentException:
